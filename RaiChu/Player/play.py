    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("❅ 𝐆𝐑𝐎𝐔𝐏 ❅", url=f"https://t.me/VipFreinds"),
                            InlineKeyboardButton("✧ 𝐎𝐅𝐅𝐈𝐂𝐄 ✧", url=f"https://t.me/VipFreinds")
                        ]
                    ]
                )
            )
        ...
        f"⚡"
            ...
            if search == 0:
                ...
                info = f"https://t.me/its_Me_SakiL?start=info_{videoid}"
