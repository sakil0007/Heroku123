...
def stream_markup(user_id, dlurl):
  buttons = [
    [
      InlineKeyboardButton(text="🇮🇳 𝐀𝐝𝐝 𝐌𝐞 𝐌𝐨𝐢 𝐋𝐮𝐯 🇮🇳", url=f"https://t.me/Sakil_XMusic_bot?startgroup=true")
    ],
    [
    ...
    [
      InlineKeyboardButton(text="🌷𝐉𝐨𝐢𝐧 𝐏𝐥𝐬🍒", url=f"https://t.me/VipFreinds"),
      InlineKeyboardButton(text="🍒𝐂𝐨𝐦𝐞 𝐁𝐚𝐛𝐲😘", url=f"https://t.me/VipFreinds")
    ],
    [
...
def menu_markup(user_id):
  buttons = [
     ...
     [InlineKeyboardButton(text="🔇", callback_data=f'cbmute | {user_id}'),
      InlineKeyboardButton(text="💞𝐂𝐨𝐦𝐞 𝐁𝐚𝐛𝐲💞", url=f""),
